...
const CACHE = "pipsily-v87";
const SHELL = ["./","./index.html","./login.html","./account.html","./player.html","./styles.css?v=77","./player.css","./app.js?v=87","./auth.js","./player.js?v=51","./manifest.webmanifest","./logo.svg","./icons/icon-192.png","./icons/icon-512.png","./version.json"];
