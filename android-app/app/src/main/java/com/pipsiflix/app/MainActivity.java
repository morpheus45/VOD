...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Résidus de la dernière mise à jour : l'APK téléchargée et son entrée
    ...
    private void configureWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                ...
                // Ne remplacer TOUTE l'app par l'écran d'erreur QUE si c'est la page
                // principale (même origine) qui échoue — pas une image/CDN secondaire.
            ...
            public boolean onRenderProcessGone(WebView view, RenderProcessGoneDetail detail) {
                ...
                // Anti-boucle : si le renderer meurt plusieurs fois en peu de temps
                // (mémoire saturée), on arrête proprement au lieu de boucler.
